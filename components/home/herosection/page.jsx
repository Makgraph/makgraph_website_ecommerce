...
const HeroSection = () => {
  return (
    <div className="mt-20 md:mt-28 h-[100%]">
      <div className="p-screen grid md:grid-cols-[100px_repeat(2,_1fr)]">
        ...
        <div className="w-auto h-auto col-span-2 md:col-span-1 md:max-h-[520px] pt-5 md:pt-0 flex-col justify-center  md:gap-5 items-center inline-flex md:px-2">
          ...
          <div className="self-stretch justify-center items-center inline-flex ">
            <div className="grow  shrink basis-0 text-center ">
              <div className="animate-slideInLeftSlow2">
                <p className="blue_gradient text-3xl md:text-5xl font-extrabold font-sans">
                  Design unique
                  <br />
                  sur vos maillots.
                  <br />
          ...
          <div>
            <div className="labelmd ">
              <div className="animate-slideInLeftSlow4">
                <Link href="/galerie" className="cursor-pointer">
                  <button className="btn-icon animate-scalebtn md:text-base">
                    Voir plus de modele
